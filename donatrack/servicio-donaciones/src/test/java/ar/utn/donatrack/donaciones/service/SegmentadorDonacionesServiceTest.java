...
class SegmentadorDonacionesServiceTest {
  ...
  private final SegmentadorDonacionesRepository repository = new SegmentadorDonacionesRepository(new ArrayList<>());
  private final SegmentadorDonacionesService segmentador = new SegmentadorDonacionesService(repository);
  private final Subcategoria subRopa = new Subcategoria("Ropa", "Camisa");
  private final Subcategoria subAlimento = new Subcategoria("Alimento", "Leche");
